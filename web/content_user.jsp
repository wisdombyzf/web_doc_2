        ...
        <div class="panel admin-panel">
            ...
            <table class="table table-hover">
                ...
                <%
                    ...
                    ArrayList<Integer> arrayList=articleService.getUserArticle(user.getId());
                ...
                <tr class="odd">
                    ...
                    <td>
                        <a class="button border-green button-little" href="#"
                           onclick="queryInfo('<% out.print(vo.getId());
                                                    clickArtcle=vo;%>','check_pending')">详情</a>
                        <a class="button border-blue button-little" href="#"
                           onclick="queryInfo('<%out.print(vo.getId());
                                                    clickArtcle=vo;%>','news')">修改</a>
                        <a class="button border-red button-little" href="#"
                           onclick="deleteArticleByUer('<%=vo.getId()%>','js坑坑')">删除</a>
                    </td>
                </tr>
                <%
                    }
                ...
                <div class="tab-body">
                    ...
                    <div class="tab-panel active" id="tab-set">
                            ...
                            <div class="form-group">
                                ...
                                <br>
                                <div class="field">
                                    <label>文章类型(请用英文逗号分割)</label> <input type="text" class="input" id="check_type" size="50"
                                                               value=""/>
                                </div>
                                <br>
                            ...
                            <div class="form-group">
                                ...
                                <div class="field">
                                    <textarea class="input" id="check_content" rows="30" cols="40" value=""></textarea>
                                </div>
                            </div>
